export const siteConfig = {
  ...
  /** Inland towns for local SEO + schema areaServed. */
  serviceTowns: [
    "Middle Township",
    "Lower Township",
    "Upper Township",
  ...
  keywords: [
    ...
    "Egg Harbor Township bathroom remodel",
    "Galloway Township flooring contractor",
    "Hamilton Township bathroom renovation",
    "Pleasantville flooring installation",
    "Middle Township bathroom remodel",
    "Hammonton bathroom remodeling",
